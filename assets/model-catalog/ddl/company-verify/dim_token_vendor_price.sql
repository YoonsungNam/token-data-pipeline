...
-- source: assets/model-catalog/ddl/company/dim_token_vendor_price.sql
-- params: --fact=token_verify_fact --dim=token_verify_dim --mart=token_verify_mart --account=token_verify
-- =============================================================

-- =============================================================
-- Company/Stage ClickHouse DDL — token_verify_dim.dim_token_vendor_price (설계 2026-08-31 §4.2, P0-stretch — 사외 API 비용, 정의서 3.9)
...
CREATE TABLE IF NOT EXISTS token_verify_dim.dim_token_vendor_price_local
...
ENGINE = ReplicatedMergeTree(
    '/clickhouse/tables/{shard}/token_verify_dim/dim_token_vendor_price_local',
    '{replica}'
)
ORDER BY (provider, model, tier, effective_from)
SETTINGS index_granularity = 8192;

CREATE TABLE IF NOT EXISTS token_verify_dim.dim_token_vendor_price_dist
ON CLUSTER 'gpu-monitoring'
(
...
ENGINE = Distributed('gpu-monitoring', 'token_verify_dim', 'dim_token_vendor_price_local', cityHash64(model));
