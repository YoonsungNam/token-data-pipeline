...
-- source: assets/model-catalog/ddl/company/dim_token_model.sql
-- params: --fact=token_verify_fact --dim=token_verify_dim --mart=token_verify_mart --account=token_verify
-- =============================================================

-- =============================================================
-- Company/Stage ClickHouse DDL — token_verify_dim.dim_token_model
...
CREATE TABLE IF NOT EXISTS token_verify_dim.dim_token_model_local
...
ENGINE = ReplicatedMergeTree(
    '/clickhouse/tables/{shard}/token_verify_dim/dim_token_model_local',
    '{replica}'
)
ORDER BY (model, effective_from)
SETTINGS index_granularity = 8192;

CREATE TABLE IF NOT EXISTS token_verify_dim.dim_token_model_dist
ON CLUSTER 'gpu-monitoring'
(
    model                       String,
    effective_from              Date,
...
ENGINE = Distributed('gpu-monitoring', 'token_verify_dim', 'dim_token_model_local', cityHash64(model));
