...
-- source: assets/model-catalog/ddl/company/dim_token_gpu_allocation.sql
-- params: --fact=token_verify_fact --dim=token_verify_dim --mart=token_verify_mart --account=token_verify
-- =============================================================

-- =============================================================
-- Company/Stage ClickHouse DDL — token_verify_dim.dim_token_gpu_allocation (설계 2026-08-31 §4.2, P0-stretch — Layer C)
...
CREATE TABLE IF NOT EXISTS token_verify_dim.dim_token_gpu_allocation_local
...
ENGINE = ReplicatedMergeTree(
    '/clickhouse/tables/{shard}/token_verify_dim/dim_token_gpu_allocation_local',
    '{replica}'
)
ORDER BY (service_group, gpu_type, effective_from)
SETTINGS index_granularity = 8192;

CREATE TABLE IF NOT EXISTS token_verify_dim.dim_token_gpu_allocation_dist
ON CLUSTER 'gpu-monitoring'
(
...
ENGINE = Distributed('gpu-monitoring', 'token_verify_dim', 'dim_token_gpu_allocation_local', cityHash64(service_group));
