...
-- source: collectors/token-metrics/ddl/company/dim_token_metrics_service.sql
-- params: --fact=token_verify_fact --dim=token_verify_dim --mart=token_verify_mart --account=token_verify
-- =============================================================

-- =============================================================
-- Company/Stage ClickHouse DDL — token_verify_dim.dim_token_metrics_service (설계 2026-08-31 §4.3)
...
-- 기존 token_verify_dim.dim_token_service(토큰 레지스트리)와 무접촉 — 메트릭 싱크 전용 레지스트리
...
CREATE TABLE IF NOT EXISTS token_verify_dim.dim_token_metrics_service_local
...
ENGINE = ReplicatedMergeTree(
    '/clickhouse/tables/{shard}/token_verify_dim/dim_token_metrics_service_local',
    '{replica}'
)
ORDER BY (service)
SETTINGS index_granularity = 8192;

CREATE TABLE IF NOT EXISTS token_verify_dim.dim_token_metrics_service_dist
ON CLUSTER 'gpu-monitoring'
(
...
ENGINE = Distributed('gpu-monitoring', 'token_verify_dim', 'dim_token_metrics_service_local', rand());
