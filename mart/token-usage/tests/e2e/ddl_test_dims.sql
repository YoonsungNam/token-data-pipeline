-- =============================================================
-- E2E 전용 dim_token_user_org / dim_token_model 단일노드 정본 (Plan 3 T5)
...
-- `{DB_DIM}.dim_token_user_org_dist`/`dim_token_model_dist`를 하드코딩 참조하므로 테이블명은
...
-- dim_token_user_org: user-0000~0019 20명, org_path 3종 (X팀 7명 / Y팀 7명 / Z팀 6명),
...
-- dim_token_model: opus/sonnet만 단가 4종 등록. claude-haiku-4-5는 의도적 미등록
