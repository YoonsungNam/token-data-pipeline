...
-- source: assets/model-catalog/ddl/company/seed_dim_token_gpu_tco.sql
-- params: --fact=token_verify_fact --dim=token_verify_dim --mart=token_verify_mart --account=token_verify
-- =============================================================

-- =============================================================
-- token_verify_dim.dim_token_gpu_tco 시드 (설계 2026-08-31 §4.2 — dim_holiday 3요소 패턴)
...
INSERT INTO token_verify_dim.dim_token_gpu_tco_dist
...
WHERE (gpu_type, effective_from) NOT IN (
    SELECT gpu_type, effective_from FROM token_verify_dim.dim_token_gpu_tco_dist
)
...
FROM token_verify_dim.dim_token_gpu_tco_dist
