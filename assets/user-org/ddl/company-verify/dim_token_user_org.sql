...
-- source: assets/user-org/ddl/company/dim_token_user_org.sql
-- params: --fact=token_verify_fact --dim=token_verify_dim --mart=token_verify_mart --account=token_verify
-- =============================================================

-- =============================================================
-- Company/Stage ClickHouse DDL — token_verify_dim.dim_token_user_org
...
CREATE TABLE IF NOT EXISTS token_verify_dim.dim_token_user_org_local
ON CLUSTER 'gpu-monitoring'
(
    user_id        String                 COMMENT '사내 id (token_verify_fact.user_id와 동일 체계)',
...
ENGINE = ReplicatedMergeTree(
    '/clickhouse/tables/{shard}/token_verify_dim/dim_token_user_org_local',
    '{replica}'
)
ORDER BY (user_id, effective_from)
SETTINGS index_granularity = 8192;

CREATE TABLE IF NOT EXISTS token_verify_dim.dim_token_user_org_dist
ON CLUSTER 'gpu-monitoring'
(
    user_id        String,
    effective_from Date,
...
ENGINE = Distributed('gpu-monitoring', 'token_verify_dim', 'dim_token_user_org_local', cityHash64(user_id));
